        ...
        <div className="grid grid-cols-2 gap-4">
          {formData.experience && (
            <div>
              ...
              <Badge
                variant="outline"
                className="text-zinc-700 dark:text-zinc-300 border-zinc-200 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-800/50"
              >
                {formData.experience}
              </Badge>
            </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              {formData.interviews.map((round, i) => (
                <div
                  key={i}
                  className="flex items-start gap-3 p-3 rounded-lg bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-800"
                >
